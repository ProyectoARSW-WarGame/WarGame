...
var updateRegion = async(region)=>{
    y = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/updateregion', {
        method: "PUT",
...
var addPlayer = async()=>{
     y = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/putplayer', {
        method: "PUT",
...
var getPlayers = async()=>{
    x = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/getplayers', {
        mode: 'no-cors',
        method: 'GET',
        headers: {
...
var updateAllRegions = async()=>{
    y = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/updateallregion', {
        method: "PUT",
...
var putAllMap = async()=>{
    y = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/putregions', {
        method: "PUT",
        body: JSON.stringify(regiones),
        headers: {"Content-type" : "application/json"}
    }).then(res=>console.log(res));
...
var getRegion = async(id)=>{
    z = await fetch('http://ec2-3-95-220-46.compute-1.amazonaws.com:8080/wargame/getRegion/' + id  + '/', {
        mode: 'no-cors',
        method: 'GET',
        headers: {
            "Content-type": "application/json"
